...
<title>Curso de Personal Training</title>
...
<div class="container">
        ...
        <h1 class="wow fadeInLeft delay-05s"><strong>ENTRENADOR PERSONAL</strong></h1>
        <div class="cabecera wow fadeInDown delay-09s"><a href="#" class="btn btn-default btn-lg video" data-video="https://www.youtube.com/embed/h3bq22WQzxU" data-toggle="modal" data-target="#videoModal"><img src="../img/clases/personal training.jpg" alt="" title="HAZ CLICK PARA MIRAR EL VIDEO"></a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!--fin div modal-->
        <hr>
        <p class="wow fadeInLeft delay-05s" style="font-size:16px">El entrenador personal analiza la condición física de sus clientes a partir de test de aptitud física, pacta las metas tanto de mejora de la condición física como de la salud en un marco temporal, donde se valorara los resultados obtenidos a partir del entrenamiento y las pautas nutricionales seguidas. Para conseguir las metas el entrenador personal diseña un programa de entrenamiento adaptado a la condición física y los objetivos que desea alcanzar el cliente</p>
        <hr>
       <!--botones-->
       <?php include ('plantilla_cursos/botones.php');?>
       <!--fin botones-->
         
        <a class="link1 animated fadeInUp delay-1s btn-lg video" href="#" data-video="https://www.youtube.com/embed/UMqPeuh-duE" data-toggle="modal" data-target="#videoModal" title="MIRA EL VIDEO"><span class="glyphicon glyphicon-play"  ></span></a>
...
<div class="tab-content">
  ...
  <br>
    <h3> </h3>
    <p class="wow fadeInLeft delay-05s" style="font-size:16px">Un entrenador personal es un profesional del fitness, cualificado en actividad física, que prescribe ejercicios, motiva y fija metas de forma individualizada, teniendo en cuenta las condiciones físicas y los objetivos de cada uno de sus clientes.  
<br>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../img/Entrenador Personal/ejercicios dirigidos.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="../img/Entrenador Personal/ejercicios personalizados.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item active">
      <img src="../img/Entrenador Personal/entrenador personal.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
