...
<title>Curso  de Funcional Training</title>
...
<div class="container">
        ...
        <h1 class="wow fadeInLeft delay-05s"><strong>FUNCIONAL TRAINING</strong></h1>
        <div class="cabecera wow fadeInDown delay-09s"><a href="#" class="btn btn-default btn-lg video" data-video="https://www.youtube.com/embed/RTTvBQgyllI" data-toggle="modal" data-target="#videoModal"><img src="../img/clases/functional training.jpg" alt="" title="HAZ CLICK PARA MIRAR EL VIDEO"></a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!--fin div modal-->
        <hr>
        <p class="wow fadeInLeft delay-05s" style="font-size:16px">,Comenzó en los años '90 como un método para entrenar a deportistas y una herramienta usada en la rehabilitación. Hoy en día el concepto se amplió e integra a cualquier persona que quiere ganar masa muscular, perder peso y sentirse más saludable.Es un concepto de fitness que tiene conexión directa al grado de funcionalidad de los movimientos o actividades que realizamos al entrenar. Se trata de mejorar la capacidad funcional de las actividades individuales. </p>
        <hr>
        
       <!--botones-->
       <?php include ('plantilla_cursos/botones.php');?>
       <!--fin botones-->
        <a class="link1 animated fadeInUp delay-1s btn-lg video" href="#" data-video="https://www.youtube.com/embed/RTTvBQgyllI" data-toggle="modal" data-target="#videoModal" title="MIRA EL VIDEO"><span class="glyphicon glyphicon-play"  ></span></a>
        <!---->
...
<br>
En este vídeo podéis ver cómo Luis Ganso, Entrenador Personal de SHA Wellness Clinic, realiza algunos de los ejercicios que podrían incorporarse en un entrenamiento funcional con parte del material del que disponemos en nuestra Área Fitness.</p>
  </div>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../img/Funcional Training/circuitos.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="../img/Funcional Training/ejercicios funcionales.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item active">
      <img src="../img/Funcional Training/Kroop 3D.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
