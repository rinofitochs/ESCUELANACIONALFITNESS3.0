...
<div class="container">
        ...
        <h1 class="wow fadeInLeft delay-05s"><strong>PILATES</strong></h1>
        <div class="cabecera wow fadeInDown delay-09s"><a href="#" class="btn btn-default btn-lg video" data-video="https://www.youtube.com/embed/RpKLwxVG6uo" data-toggle="modal" data-target="#videoModal"><img src="../img/clases/pilates.png" alt="" title="HAZ CLICK PARA MIRAR EL VIDEO"></a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!--fin div modal-->
        <hr>
        <p class="wow fadeInLeft delay-05s" style="font-size:16px">El <strong>método Pilates</strong>, o simplemente <strong>Pilates</strong>, es un sistema de <a href="https://es.wikipedia.org/wiki/Entrenamiento" title="Entrenamiento">entrenamiento</a> físico y mental creado a principios del <a href="https://es.wikipedia.org/wiki/Siglo_XX" title="Siglo XX">siglo XX</a> por <a href="https://es.wikipedia.org/wiki/Joseph_Hubertus_Pilates" title="Joseph Hubertus Pilates">Joseph Hubertus Pilates</a>, quien lo ideó basándose en su conocimiento de distintas especialidades como <a href="https://es.wikipedia.org/wiki/Gimnasia" title="Gimnasia">gimnasia</a>, <a href="https://es.wikipedia.org/wiki/Traumatolog%C3%ADa" title="Traumatología">traumatología</a> y <a href="https://es.wikipedia.org/wiki/Yoga" title="Yoga">yoga</a>, uniendo el dinamismo y la fuerza muscular con el control mental, la <a href="https://es.wikipedia.org/wiki/Respiraci%C3%B3n" title="Respiración">respiración</a> y la <a href="https://es.wikipedia.org/wiki/T%C3%A9cnica_de_relajaci%C3%B3n" title="Técnica de relajación">relajación</a>.</p>
        <hr>
        
    <!--botones-->
       <?php include ('plantilla_cursos/botones.php');?>
       <!--fin botones-->
        <a class="link1 animated fadeInUp delay-1s btn-lg video" href="#" data-video="https://www.youtube.com/embed/RpKLwxVG6uo" data-toggle="modal" data-target="#videoModal" title="MIRA EL VIDEO"><span class="glyphicon glyphicon-play"  ></span></a>
        <!---->
...
<div class="tab-content">
  ...
  <br>
    <h3> </h3>
    <p class="wow fadeInLeft delay-05s" style="font-size:16px">sEl pilates es una de las actividades que ha marcado tendencia y actualmente conserva su popularidad, por ello, hoy nos adentramos en el mundo de la ciencia para mostrarte todo lo que el pilates puede hacer por tu cuerpo y los beneficios que ofrece al organismo.
<br>
...
| Archives of Physical Medicine and Rehabilitation, Volume 85, Issue 12, December 2004, Pages 1977–1981; Journal of Bodywork and Movement Therapies, Volume 12, Issue 4, October 2008, Pages 364–370 </p>
  </div>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../img/Pilates/pilates basico.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="../img/Pilates/pilates avanzado.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item active">
      <img src="../img/Pilates/pilates mat.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
