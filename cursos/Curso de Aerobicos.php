...
<title>Curso de Aerobics Step</title>
...
<div class="container">
        ...
        <h1 class="wow fadeInLeft delay-05s"><strong>AEROBIC & STEP</strong></h1>
        <div class="cabecera wow fadeInDown delay-09s"><a href="#" class="btn btn-default btn-lg video" data-video="https://www.youtube.com/embed/UMqPeuh-duE" data-toggle="modal" data-target="#videoModal"><img src="../img/clases/aerobic.png" alt="" title="HAZ CLICK PARA MIRAR EL VIDEO"></a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!--fin div modal-->
        <hr>
        <p class="wow fadeInLeft delay-05s" style="font-size:16px">Es un tipo de <a href="https://es.wikipedia.org/wiki/Gimnasia" title="Gimnasia">gimnasia</a> que se realiza al son de la <a href="https://es.wikipedia.org/wiki/M%C3%BAsica" title="Música">música</a>, en un <a href="https://es.wikipedia.org/wiki/Sal%C3%B3n" title="Salón">salón</a> o al aire libre. El aeróbic reúne todos los beneficios del <a href="https://es.wikipedia.org/wiki/Ejercicio_aer%C3%B3bico" title="Ejercicio aeróbico">ejercicio aeróbico</a>, además de ejercitar capacidades físicas como la flexibilidad, coordinación, orientación, ritmo, etc. El ritmo de las sesiones de aeróbic varía en función de la edad del público que lo practica..</p>
        <hr>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../img/aerobicos/clase de step.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="../img/aerobicos/clase de aerobic.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item active">
      <img src="../img/aerobicos/masterclass Aerobic Step.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
