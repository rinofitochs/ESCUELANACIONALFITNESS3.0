...
<div class="container">
        ...
        <h1 class="wow fadeInLeft delay-05s"><strong>TAI CHI</strong></h1>
        <div class="cabecera wow fadeInDown delay-09s"><a href="#" class="btn btn-default btn-lg video" data-video="https://www.youtube.com/embed/Z4KHjtMzOHQ" data-toggle="modal" data-target="#videoModal"><img src="../img/clases/tai-chi.jpg" alt="" title="HAZ CLICK PARA MIRAR EL VIDEO"></a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!--fin div modal-->
        <hr>
        <p class="wow fadeInLeft delay-05s" style="font-size:16px"> <em>tai chi</em> es un <a href="https://es.wikipedia.org/w/index.php?title=Arte_marcial_interno&action=edit&redlink=1" title="Arte marcial interno (aún no redactado)">arte marcial interno</a> (en <a href="https://es.wikipedia.org/wiki/Idioma_chino" title="Idioma chino">chino</a>: 內家拳, <a href="https://es.wikipedia.org/wiki/Pinyin" title="Pinyin">pinyin</a>: <em>nèijiāquán</em>) para la lucha cuerpo a cuerpo, ya sea armada o desarmada. En tiempos más recientes se lo considera cada vez más como una práctica físico-espiritual para mejorar la calidad de vida tanto física como mental. Por una parte sería muy provechosa para la salud, mientras que por otra constituye una técnica de meditación (meditación en movimiento).</p>
        <hr>
        
        <!--botones-->
       <?php include ('plantilla_cursos/botones.php');?>
        <a class="link1 animated fadeInUp delay-1s btn-lg video" href="#" data-video="https://www.youtube.com/embed/Z4KHjtMzOHQ" data-toggle="modal" data-target="#videoModal" title="MIRA EL VIDEO"><span class="glyphicon glyphicon-play"  ></span></a>
        <!---->
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      <img src="../img/tai-chi/ejercicios de tai-chi.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item active">
      <img src="../img/tai-chi/tai-chi.jpg"  class="img-responsive" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
